...
class FormController extends Controller
{
    ...
    public function listaopciones(Request $request, $id)
    {
        $opciones = Respuesta::select('respuestas.opcion')->join('preguntas','respuestas.preguntas_id','=','preguntas.id')
        ->where('preguntas.id',$id)->get();

        //return $opciones;
       // return view('encuestas.form',compact('opciones'));
        ...
        return view('encuestas.form',compact('rubros','departamentos','ciudades','preguntas','respuestas','opciones','encuesta'));
    }
